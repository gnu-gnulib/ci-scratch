...
src_libsinglebin___a_DEPENDENCIES = src/libsinglebin_test.a
src_libsinglebin_false_a_DEPENDENCIES = src/libsinglebin_true.a
...
src_libsinglebin___a_SOURCES = src/coreutils-lbracket.c
src_libsinglebin___a_ldadd =   $(src_test_LDADD) src/libsinglebin_test.a
src_libsinglebin___a_CFLAGS = "-Dmain=single_binary_main_lbracket (int, char **);  int single_binary_main_lbracket"  -Dusage=_usage_lbracket $(src_coreutils_CFLAGS)
# Command b2sum
...
src_libsinglebin_env_a_SOURCES =   src/env.c src/operand2sig.c src/printenv.h
...
src_libsinglebin_false_a_SOURCES = src/coreutils-false.c
src_libsinglebin_false_a_ldadd =   $(src_true_LDADD) src/libsinglebin_true.a
...
src_libsinglebin_logname_a_ldadd =   $(READUTMP_LIB)
...
src_libsinglebin_printenv_a_SOURCES =   src/printenv.c src/printenv.h
...
src_libsinglebin_test_a_SOURCES =   src/test.c src/test-test.c
...
src_libsinglebin_true_a_SOURCES =   src/true.c src/true-true.c
